...
2. The first player in any player array is the goalkeeper and the others are
 field players. For Bayern Munich (team 1) create one variable ('gk')
  with the goalkeeper's name, and one array ('fieldPlayers') with all 
  the remaining 10 field players
...
the console which team is more likely to win, 
...
//2. create array of team1 gk first player and the rest fieldPlayers
const [gk, ...fieldPlayers] = players1;
console.log(gk, fieldPlayers);

//3. create an array with all 22 players
...
function printGoals(...a) {
  console.log(...a);
  console.log('Total goals scored ' + a.length);
}
printGoals('Bob', 'Sally');
