...
The method does 2 things:
  ...
  option is 3, increase the value AT POSITION 3 of the array by 
  1. Make sure to check if the input is a number and if the 
...
const poll = {
  ...
  //This generates [0, 0, 0, 0].. more on this next section.
  ...
  registerNewAnswer() {
    ...
    //CHECK IF NUMBER AND it is a number that makes sense
    if (answer != NaN && answer <= 3 && answer >= 0) {
      //if complies then increase count at idx location
      poll.answers[answer]++;
    } else {
...
//we used the displayResults method of the poll object - but had to
//use a differenct "this" keywork the call method allows the keyword to be changed
//furthermore in this example we created a new object between the {} and added the
//data we wanted to pass into the displayResults method.
